...
{ 
  ...
  return (
    ...
    <a class="nav-link " id="v-pills-settings-tab" data-toggle="pill" href="/home/faculty/Courses/files" role="tab" aria-controls="v-pills-settings" aria-selected="false">Files</a>
    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="/home/faculty/Courses/submission" role="tab" aria-controls="v-pills-settings" aria-selected="false">Submissions</a>
    </div>

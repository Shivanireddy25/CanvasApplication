...
{ 
  ...
  return (
    ...
    <a class="nav-link "  style = {{display : "inline"}}id="v-pills-settings-tab" data-toggle="pill" href="/home/student/Courses/files" role="tab" aria-controls="v-pills-settings" aria-selected="false">Files</a>
